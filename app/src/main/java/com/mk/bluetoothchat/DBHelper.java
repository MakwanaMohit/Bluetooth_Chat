...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTableQuery = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (" + COLUMN_MESSAGE_ID + " TEXT PRIMARY KEY, " + COLUMN_SENDER_NAME + " TEXT, " + COLUMN_SENDER_ID + " TEXT, " + COLUMN_MESSAGE + " TEXT, " + COLUMN_PRIVATE_KEY + " TEXT)";
    ...
    public Message getMessageByIndex(int index) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            Message message = new Message(cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_SENDER_NAME)), cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_SENDER_ID)), cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_MESSAGE)), cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_PRIVATE_KEY)));
